"""Client for the node's message broker.

Used during analysis teardown to remove the analysis' subscription from the
message broker running alongside the Pod Orchestration service.
"""
...
def delete_subscription(
    ...
    Network and HTTP errors are logged rather than raised, so a message broker
    that is unreachable cannot block analysis teardown.
    ...
    try:
        ...
        logger.warning(
            f"Could not reach Message-Broker service to delete analysis subscription "
